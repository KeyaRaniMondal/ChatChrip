...
const navigate = useNavigate();
    ...
    return (
      <div className="w-full flex flex-col md:flex-row justify-around items-start my-28 px-6 md:px-16 gap-10">
        {/* Ask Questions Section */}
        <div className="w-full md:w-1/2 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold text-center  py-2 rounded-t-md ">
            Ask Your Questions
          </h2>
          <p>Ask questions to clear your doubt and get chance to interact and connect with community ..</p>
          <textarea
